...
export class ProductsLambdaStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const lambdaFunction2 = new lambda.Function(this, 'getProductById', {
            runtime: lambda.Runtime.NODEJS_20_X,
            memorySize: 1024,
            timeout: cdk.Duration.seconds(5),
        ...
        const ProductsLambdaIntegration2 = new apigateway.LambdaIntegration(lambdaFunction2);
        const productByIdResource = productsResource.addResource('{id}')


        productsResource.addMethod('GET', ProductsLambdaIntegration);
        productByIdResource.addMethod('POST', ProductsLambdaIntegration2);
    }
}
